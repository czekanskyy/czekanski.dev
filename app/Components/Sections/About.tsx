  ...
  return (
    <div id={id || 'about'} className={`min-h-screen ${firaCode.className} flex flex-col max-w-[1200px] mx-auto p-8 pt-28 pb-28 justify-center snap-start`}>
      ...
      <div className='flex flex-col md:grid grid-cols-12 gap-12 items-start'>
        ...
        <div className='md:col-span-7 lg:col-span-8 xl:col-span-9 flex flex-col gap-6 text-justify text-neutral-400 text-lg leading-relaxed break-words max-w-full [&_img]:max-w-full [&_img]:h-auto [&_pre]:whitespace-pre-wrap [&_pre]:break-all'>
